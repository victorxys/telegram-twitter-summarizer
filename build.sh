...
echo ""
echo "✅ 成功构建并推送 ${IMAGE_NAME}:${NEW_VERSION} 和 ${IMAGE_NAME}:latest。"
echo ""
echo "下一步: 在你的服务器上，修改 docker-compose.yml 文件以使用新版本 '${NEW_VERSION}'，然后运行 'docker-compose pull && docker-compose up -d'。"
